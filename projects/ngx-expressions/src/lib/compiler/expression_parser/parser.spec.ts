...
import { ASTWithSource, BindingPipe, Interpolation, ParserError, TemplateBinding } from './ast';
import { Parser, SplitInterpolation, TemplateBindingParseResult } from './parser';
...
describe('parser', () => {
  ...
  describe('parseTemplateBindings', () => {
    ...
    it('should parse pipes', () => {
      ...
      expect(ast instanceof BindingPipe).toEqual(true);
      // expect(ast).toBeAnInstanceOf();
    });
...
function parseTemplateBindingsResult(key: string, value: string, location: any = null): TemplateBindingParseResult {
  return createParser().parseTemplateBindings(key, value, location);
}

function parseTemplateBindings(key: string, value: string, location: any = null): TemplateBinding[] {
